...
@Component({
    selector: 'app-boundcalc-data-generation-models',
    templateUrl: './boundcalc-data-generation-models.component.html',
    styleUrls: ['./boundcalc-data-generation-models.component.css']
})
export class BoundCalcDataGenerationModelsComponent extends DataTableBaseComponent<GenerationModelEntry> {
    ...
    add() {
        if ( this.datasetsService.currentDataset?.isReadOnly) {
            ...
            this.dialogService.showBoundCalcGenerationModelDialog(undefined, (resp: DatasetData<any>[] | undefined) => {
                if (resp) {
    ...
    edit(tm: GenerationModel) {
        this.dialogService.showBoundCalcGenerationModelDialog(tm,(resp: DatasetData<any>[] | undefined)=>{
            if ( resp ) {
                // this will be the newly created generation model
                let sm = resp.find(m=>m.tableName==="GenerationModel")?.data[0]
                if ( sm ) {
