...
import { BoundCalcDataService, PercentCapacityThreshold as FlowCapacityThreshold } from '../../boundcalc-data-service.service';
...
@Component({
  selector: 'app-boundcalc-data-branches',
  templateUrl: './boundcalc-data-branches.component.html',
  styleUrls: ['../boundcalc-data-common.css','../../../datasets/data-table-base/data-table-base.component.css','./boundcalc-data-branches.component.css']
})
export class BoundCalcDataBranchesComponent extends DataTableBaseComponent<Branch> {
    ...
    add() {
        this.dialogService.showBoundCalcBranchDialog();
    }
