...
import { GridSubstationLocation, GridSubstationLocationSource, BoundCalcCtrlType } from 'src/app/data/app.data';
...
@Component({
    selector: 'app-boundcalc-data-locations',
    templateUrl: './boundcalc-data-locations.component.html',
    styleUrls: ['../boundcalc-data-common.css','../../../datasets/data-table-base/data-table-base.component.css','./boundcalc-data-locations.component.css']
})
export class BoundCalcDataLocationsComponent extends DataTableBaseComponent<GridSubstationLocation> {
    ...
    edit( e: ICellEditorDataDict) {
        this.dialogService.showBoundCalcLocationDialog(e);
    }

    add() {
        this.dialogService.showBoundCalcLocationDialog();
    }
