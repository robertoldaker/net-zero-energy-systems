...
@Component({
    selector: 'app-boundcalc-dialog',
    templateUrl: './boundcalc-dialog.component.html',
    styleUrls: ['./boundcalc-dialog.component.css']
})

export class BoundCalcDialogComponent extends ComponentBase {
