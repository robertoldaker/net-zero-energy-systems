...
import { IBranchEditorData, BoundCalcDataService } from '../../boundcalc-data-service.service';
...
@Component({
  selector: 'app-boundcalc-branch-dialog',
  templateUrl: './boundcalc-branch-dialog.component.html',
  styleUrls: ['../../../dialogs/dialog-base.css','./boundcalc-branch-dialog.component.css']
})

export class BoundCalcBranchDialogComponent extends DialogBase {
    ...
    save() {
        if ( this.datasetsService.currentDataset) {
            ...
            this.boundcalcService.saveDialog(id, "Branch",changedControls, () => {
