...
import { BoundCalcLink, PercentCapacityThreshold, UpdateLocationData } from "../boundcalc-data-service.service";

export class LinkLabelData {
    constructor(private mapComponent: BoundCalcMapComponent) {

    }
    private linkLabelData: MapOptions<google.maps.marker.AdvancedMarkerElementOptions,BoundCalcLink> = new MapOptions()
    get markerOptions():IMapData<google.maps.marker.AdvancedMarkerElementOptions,BoundCalcLink>[] {
    ...
    private updateExistingMarker(am: google.maps.marker.AdvancedMarkerElement, link: BoundCalcLink, tol: number) {
    ...
    private getPos(link: BoundCalcLink): google.maps.LatLngLiteral  {
    ...
    private getLinkLabelOptions(link: BoundCalcLink, tol: number): google.maps.marker.AdvancedMarkerElementOptions {
    ...
    private getLabel(link: BoundCalcLink):string {
    ...
    private getLinkInfo(link: BoundCalcLink, tol: number):{cn: string, zIndex: number, label: string } {
    ...
    private showLabel(link: BoundCalcLink, flowFilter: MapFlowFilter, percentThreshold: PercentCapacityThreshold) {
        let ds = this.mapComponent.dataService
        if ( flowFilter === MapFlowFilter.All ) {
            return true;
