...
@Component({
    selector: 'app-loadflow-location-dialog',
    templateUrl: './loadflow-location-dialog.component.html',
    styleUrls: ['../../../dialogs/dialog-base.css','./loadflow-location-dialog.component.css']
})
