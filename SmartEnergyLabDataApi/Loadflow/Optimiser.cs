...
namespace SmartEnergyLabDataApi.Loadflow
{
    public class Optimiser
    {
        ...
        public Optimiser(Loadflow loadflow, Boundary boundary) {
            lf = loadflow;
            bo = boundary;
        }
        ...
        public string ReportConstraints(StageResultEnum result = StageResultEnum.Pass) {
            int i, c;
            string res="";
        ...
        */
        ...
        public double CctSensitivity(BranchWrapper branch, double[] cvang, double? injMax) {
            ...
            if ( branch.Obj.X != 0 && !branch.Outaged ) { // ac branch
                ...
                f = (v1 - v2) * Loadflow.PUCONV / branch.Obj.X;
