...
def calculate(
    ...
    opp_estimator = OnPlotParkingEstimator(accommodation_type_counts, n_samples=1000)
    opp_samples = opp_estimator.estimate()

    vehicles_with_opp_estimator = VehiclesWithOnPlotParkingEstimator(opp_samples,
                                                                     car_van_2021_data,
                                                                     house_2021_data)
